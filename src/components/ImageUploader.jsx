      ...
      <div
        className={`relative border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-all duration-300 flex flex-col items-center justify-center min-h-36 ${
          isDragging
            ...
            : 'border-border bg-surface-muted hover:border-primary hover:bg-primary/5'
        }`}
        ...
        onClick={handleClick}
      >
        <svg className="w-10 h-10 text-foreground-muted mb-3 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor">
